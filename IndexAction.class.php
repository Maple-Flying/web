...
class IndexAction extends Action {	
    ...
    public function index(){ 	
		...
		if(session('?username')){
            ...
            //设置分页回调方法
			$show=$page->show();
			$news_list=$allnews->where("author='".$username."'")->field(array('id','subject','author','createtime','lastmodifytime'))->order('id desc')->limit($page->firstRow.','.$page->listRows)->select();
